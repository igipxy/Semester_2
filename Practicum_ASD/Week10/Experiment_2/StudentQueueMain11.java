...
public class StudentQueueMain11 {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        StudentQueue11 queue = new StudentQueue11(5);
        int choice;
        ...
        do {
            ...
            switch (choice) {
                case 1:
                    ...
                    Student11 std = new Student11(nim, name, studyProgram, className);
                    queue.enqueue(std);
                    break;

                case 2:
                    Student11 studentBeingServed = queue.dequeue();
